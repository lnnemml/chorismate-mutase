...
class MolDraw2DCairo(MolDraw2D):
    ...
    """
    __instance_size__: typing.ClassVar[int] = 1096
    @staticmethod
    def __reduce__(*args, **kwargs):
        ...
...
class MolDraw2DSVG(MolDraw2D):
    ...
    SVG molecule drawer
    """
    __instance_size__: typing.ClassVar[int] = 1480
    @staticmethod
    def __reduce__(*args, **kwargs):
        ...
...
class MolDrawOptions(Boost.Python.instance):
    ...
    Drawing options
    """
    __instance_size__: typing.ClassVar[int] = 832
    @staticmethod
    def __reduce__(*args, **kwargs):
        ...
    @staticmethod
    ...
    def addStereoAnnotation(*args, **kwargs):
        ...
    @property
    def addStereoGroupAnnotation(*args, **kwargs):
        """
    ...
    def legendPosition(*args, **kwargs):
        ...
    @property
    def legendVerticalText(*args, **kwargs):
        """
    ...
    def simplifiedStereoGroupLabel(*args, **kwargs):
        ...
    @property
    def singleColourBonds(*args, **kwargs):
        """
    ...
    def standardColoursForHighlightedAtoms(*args, **kwargs):
        ...
    @property
    def stereoGroupAbsLabel(*args, **kwargs):
        """
    ...
    def stereoGroupAbsLabel(*args, **kwargs):
        ...
    @property
    def stereoGroupAndLabel(*args, **kwargs):
        """
    ...
    def stereoGroupAndLabel(*args, **kwargs):
        ...
    @property
    def stereoGroupOrLabel(*args, **kwargs):
        """
...
def ContourAndDrawGaussians(drawer: MolDraw2D, locs: typing.Any, heights: typing.Any, widths: typing.Any, nContours: int = 10, levels: typing.Any = None, params: ContourParams = ..., mol: typing.Any = None) -> None:
    """
        ...
        */
        ...
        C++ signature :
            void ContourAndDrawGaussians(RDKit::MolDraw2D {lvalue},boost::python::api::object,boost::python::api::object,boost::python::api::object [,unsigned int=10 [,boost::python::api::object=None [,RDKit::MolDraw2DUtils::ContourParams=<rdkit.Chem.Draw.rdMolDraw2D.ContourParams object at 0x7fec0750bc40> [,boost::python::api::object=None]]]])
    """
def ContourAndDrawGrid(drawer: MolDraw2D, data: typing.Any, xcoords: typing.Any, ycoords: typing.Any, nContours: int = 10, levels: typing.Any = None, params: ContourParams = ..., mol: typing.Any = None) -> None:
    """
        ...
        */
        ...
        C++ signature :
            void ContourAndDrawGrid(RDKit::MolDraw2D {lvalue},boost::python::api::object {lvalue},boost::python::api::object {lvalue},boost::python::api::object {lvalue} [,unsigned int=10 [,boost::python::api::object {lvalue}=None [,RDKit::MolDraw2DUtils::ContourParams=<rdkit.Chem.Draw.rdMolDraw2D.ContourParams object at 0x7fec0750bd30> [,boost::python::api::object=None]]]])
    """
