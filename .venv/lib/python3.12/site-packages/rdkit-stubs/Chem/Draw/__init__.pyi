...
from rdkit.Chem.Draw.rdMolDraw2D import LegendPosition
...
__all__: list[str] = ['ALL', 'ANNOTATIONS', 'ATOMLABELS', 'BONDS', 'Bottom', 'BytesIO', 'Chem', 'CircleAndLine', 'ContourParams', 'DebugDraw', 'DrawElement', 'DrawMolWithMatches', 'DrawMorganBit', 'DrawMorganBits', 'DrawMorganEnv', 'DrawMorganEnvs', 'DrawRDKitBit', 'DrawRDKitBits', 'DrawRDKitEnv', 'DrawRDKitEnvs', 'FingerprintEnv', 'HIGHLIGHTS', 'IntStringMap', 'Lasso', 'Left', 'LegendPosition', 'MolDraw2D', 'MolDraw2DCairo', 'MolDraw2DSVG', 'MolDrawOptions', 'MolToFile', 'MolToImage', 'MolToSVG', 'MolsMatrixToGridImage', 'MolsToGridImage', 'MolsToImage', 'MultiColourHighlightStyle', 'NONE', 'POSTSHAPES', 'PRESHAPES', 'RADICALS', 'RDConfig', 'ReactionToImage', 'Right', 'SetComicMode', 'ShowMol', 'Top', 'calcAtomGaussians', 'find_spec', 'itertools', 'map_indexing_suite_IntStringMap_entry', 'namedtuple', 'numpy', 'os', 'rdBase', 'rdDepictor', 'rdMolDraw2D', 'shouldKekulize', 'warnings']
...
Bottom: rdMolDraw2D.LegendPosition  # value = rdkit.Chem.Draw.rdMolDraw2D.LegendPosition.Bottom
...
Left: rdMolDraw2D.LegendPosition  # value = rdkit.Chem.Draw.rdMolDraw2D.LegendPosition.Left
